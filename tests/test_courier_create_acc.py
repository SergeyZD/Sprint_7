...
class TestCourierCreate:
    ...
    @allure.description('Создаем нового курьера. Проверяем код и тело ответа')
    ...
    @allure.description('Создаем нового курьера и повторяем запрос оставляя логин. Проверяем код и тело ответа.')
    ...
    @allure.description('Тест без логина. Проверяем код и тело ответа.')
    ...
    @allure.description('Тест без пароля. Проверяем код и тело ответа.')
