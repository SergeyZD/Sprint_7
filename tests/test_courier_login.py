...
class TestCourierLogin:
    ...
    @allure.description('Создаем нового курьера с рандомными данными и авторизируемся. Проверяем код и тело ответа.')
    ...
    @allure.description('Тест с пустым логином. Проверяются код и тело ответа.')
    ...
    @allure.description('Тест с пустым паролем. Проверяются код и тело ответа.')
